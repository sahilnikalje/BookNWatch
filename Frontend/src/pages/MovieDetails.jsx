  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
          ...
          <div className='relative flex flex-col gap-3'>
             ...
             <p className='text-gray-400 mt-2 text-sm leading-tight max-w-xl'>
              ...
              <div className='flex items-center flex-wrap gap-4 mt-4'>
                 <button className='flex items-center gap-2 px-7 p-3 text-sm
                          bg-gray-800 hover:bg-gray-900 transition rounded-md
                           font-medium cursor-pointer active:scale-95'>
                    <PlayCircleIcon className='w-5 h-5'/>
                     Watch Trailer 
                 </button>
                 <a className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull
       ...
       <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
        ...
        <p className='text-lg font-medium mt-20 mb-8'>You May Slso Like</p>
