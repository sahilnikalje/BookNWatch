  ...
  return nowPlayingMovies.length>0 ? (
    <>
          ...
          {nowPlayingMovies.map((movie)=>(
             ...
             <div key={movie._id} onClick={()=>setSelectedMovie(movie.id)}
               ...
               <div className='relative rounded-lg overflow-hidden'>
                  <img className='w-full object-cover brightness-90'
     ...
     <div className='mt-6'>
        ...
        <div className='inline-flex gap-5 border-gray-600 p-1
                   pl-3 rounded-lg'>
            <input className='outline-none rounded-md '
               onChange={(e)=>setDateTimeInput(e.target.value)}
               value={dateTimeInput}
               type='datetime-local'
            />
            {/* <input className='outline-none rounded-md px-3 py-2
